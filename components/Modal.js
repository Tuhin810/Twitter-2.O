                ...
                <div className='relative mt-8 grid grid-cols-[48px,1fr] gap-4'>
                    ...
                    <div className='mt-4'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <PhotoIcon className='h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150' onClick={()=>filePickerRef.current.click()}/>
                        <GifIcon className='h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150'/>
                        <Squares2X2Icon className="h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150" />
                        <FaceSmileIcon className='h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150'/>
                        <CalendarIcon className='h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150'/>
                        <MapPinIcon  className='h-5 w-5 cursor-pointer transition-transform duration-100 ease-out hover:scale-150'/>
